...
#region SHARED API Calls
    ...
    async def get_broadcast_id_from_name(self, user_name: str):
        ...
        async for user in users:
            ...
            mp_print.debug(f"Broadcaster ID type: {type(broadcaster_id)}")
    ...
    async def get_channel_moderators(self, broadcaster_id: str):
        moderators = self.twitch_bot.get_moderators(broadcaster_id=broadcaster_id)
        return moderators
